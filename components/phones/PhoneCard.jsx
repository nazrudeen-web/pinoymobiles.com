...
export default function PhoneCard({ phone, index = 0 }) {
  return (
    <article className="flex h-full flex-col justify-between rounded-2xl border border-border/40 bg-white overflow-hidden hover:shadow-lg hover:border-primary/20 transition-all duration-300 group">
      {/* Image Area */}
